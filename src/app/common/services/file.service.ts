...
export class FileService {
  ...
  /* Botiene los documentos adjuntados por el estudiante */
  ...
  /* Busca el nombre del documento en BD y lo retorna */
  ...
  /*Verufica si la pregunta del formulario aosicada a un documento es "Si"
    si es asi, pone el documento como obligatoroio */
